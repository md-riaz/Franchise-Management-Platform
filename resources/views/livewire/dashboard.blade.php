<div>
    <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-gray-600">Welcome to your franchise management dashboard</p>
    </div>
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">Active Franchises</dt>
                            <dd class="text-lg font-semibold text-gray-900">{{ $activeFranchises }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-semibold text-gray-900">${{ number_format($totalSales, 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-semibold text-gray-900">${{ number_format($monthlySales, 2) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">Overdue Compliance</dt>
                            <dd class="text-lg font-semibold text-red-600">{{ $overdueCompliance }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">No sales recorded yet</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
